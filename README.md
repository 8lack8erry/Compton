...
We select these values to minimize the energy resolution \(\frac{\text{FWHM}}{\langle E \rangle}\) while avoiding operation near the boundary of the detector's optimal performance range. The energy of the photon is given by $E = h\nu$.
